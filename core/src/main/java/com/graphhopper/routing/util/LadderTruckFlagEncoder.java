...
/**
 * Defines bit layout for LadderTrucks. (speed, access, ferries, ...)
 *
 * @author Peter Karich
 * @author Nop
 */
public class LadderTruckFlagEncoder extends AbstractFlagEncoder {
    ...
    public LadderTruckFlagEncoder() {
        this(5, 5, 0);
    }

    public LadderTruckFlagEncoder(PMap properties) {
    ...
    public LadderTruckFlagEncoder(int speedBits, double speedFactor, int maxTurnCosts) {
        ...
        defaultSpeedMap.put("motorway_link", 7);
        defaultSpeedMap.put("motorroad", 9);
        // bundesstraße
        defaultSpeedMap.put("trunk", 7);
        defaultSpeedMap.put("trunk_link", 6);
        // linking bigger town
        defaultSpeedMap.put("primary", 6);
        defaultSpeedMap.put("primary_link", 6);
        // linking towns + villages
        defaultSpeedMap.put("secondary", 6);
        defaultSpeedMap.put("secondary_link", 5);
        // streets without middle line separation
        defaultSpeedMap.put("tertiary", 5);
        defaultSpeedMap.put("tertiary_link", 4);
        defaultSpeedMap.put("unclassified", 3);
        defaultSpeedMap.put("residential", 3);
        // spielstraße
        defaultSpeedMap.put("living_street", 1);
        defaultSpeedMap.put("service", 2);
        // unknown road
        defaultSpeedMap.put("road", 2);
        // forestry stuff
        defaultSpeedMap.put("track", 1);

        trackTypeSpeedMap.put("grade1", 2); // paved
        trackTypeSpeedMap.put("grade2", 1); // now unpaved - gravel mixed with ...
        trackTypeSpeedMap.put("grade3", 1); // ... hard and soft materials
    ...
    public LadderTruckFlagEncoder setSpeedTwoDirections(boolean value) {
    ...
    /**
     * Define the place of the speedBits in the edge flags for LadderTruck.
     */
    @Override
